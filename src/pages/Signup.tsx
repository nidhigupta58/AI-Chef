...
export default function Signup() {
  ...
  const { signupWithEmail, loginWithGoogle, resendVerificationEmail } = useAuth();
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    if (result.success) {
      ...
      setLoading(false);
      // Don't redirect - let user resend email if needed
    } else {
    ...
    <div className="auth-container">
      ...
      <div className="auth-card">
        ...
        <form className="auth-form" onSubmit={handleSubmit}>
          ...
          {success && (
            <div className="auth-success verification-notice">
              {success}
